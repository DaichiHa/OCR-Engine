...
def main():
    p = argparse.ArgumentParser(description="Tile an image and run PaddleOCR on each tile")
    ...
    p.add_argument("--disable-onednn", action='store_true', help="Try to disable OneDNN before import")
    args = p.parse_args()
