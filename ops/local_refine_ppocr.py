...
def run(ppocr_json, img_path, out_report='ops/local_refine_report_page010.json', score_thr=0.75, upscale=3):
    ...
    try:
        ...
        ppocr = ONNXPaddleOcr(use_angle_cls=True, use_gpu=False, use_dml=False, use_openvino=False)
        ppocr_ok = True
    except Exception as e:
        ppocr = None
...
if __name__ == '__main__':
    ...
    args = p.parse_args()
    run(args.ppocr, args.img, out_report=args.out, score_thr=args.thr, upscale=args.scale)
