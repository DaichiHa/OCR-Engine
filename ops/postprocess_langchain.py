...
def main():
    ...
    ap.add_argument('--use-llm', action='store_true', help='If set and API key present, attempt LangChain LLM pass')
    args = ap.parse_args()
    ...
    if args.use_llm and os.getenv('OPENAI_API_KEY') and os.getenv('USE_LANGCHAIN','1') != '0':
        try:
            ...
            prompt = PromptTemplate(
                ...
                template=('You are a specialist in correcting OCR output from Showa-era Japanese statistical tables. ' 
