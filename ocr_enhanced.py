...
def ocr_page_enhanced(
    ...
    try:
        ...
        configs = [
            ...
            ('jpn_vert', r'--oem 3 --psm 5'),  # PSM 5: Single uniform block of vertical text
            # Config 2: Mixed vertical/horizontal
            ('jpn_vert+jpn', r'--oem 3 --psm 6'),  # PSM 6: Assume single uniform block of text
            # Config 3: Auto orientation
            ('jpn+jpn_vert', r'--oem 3 --psm 3'),  # PSM 3: Fully automatic page segmentation
        ]
